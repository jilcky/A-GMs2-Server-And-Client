...
NetLoding = true;
	AddMassage("申请注册账号"+"_"+string(global.SeedID))
...
ShowAsyncDialog = true;
NetLoding = true;
	AddMassage("申请登陆"+"_"+string(global.SeedID))
}
//#endregion
break;
case 3:
...
ShowAsyncDialog = true;
NetLoding = true;
	AddMassage("保存信息"+"_"+string(global.SeedID))
}
//#endregion
break;
case 4:
...
ShowAsyncDialog = true;
NetLoding = true;
	AddMassage("读取信息"+"_"+string(global.SeedID))
}
//#endregion
break;
case 5:
